...
RUN echo "VITE_SUPABASE_URL=https://zqcspamakvfzvlqbunit.supabase.co" > .env.production && \
    echo "VITE_SUPABASE_ANON_KEY=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InpxY3NwYW1ha3ZmenZscWJ1bml0Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjMxMDk4MDYsImV4cCI6MjA3ODY4NTgwNn0.1ITkRtlnDA7HWlc1GisTZhikt6yhC41pN6O_8_hu9co" >> .env.production && \
